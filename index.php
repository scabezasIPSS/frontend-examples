...
<head>
    ...
    <meta name="author" content="Sebastián Cabezas">
    <meta name="description" content="Web de prototipado">
</head>
...
<body id="inicio">
    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-body-tertiary">
        ...
        <div class="container">
            <a class="navbar-brand" href="#"><img src="assets/img/logo/logo-grande.webp" style="height: 48px;" alt=""></a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="assets/img/imagen1.webp" style="width: 100%;" alt="...">
            </div>
            <div class="carousel-item">
                <img src="assets/img/imagen2.webp" style="width: 100%;" alt="...">
            </div>
            <div class="carousel-item">
                <img src="assets/img/imagen3.webp" style="width: 100%;" alt="...">
            </div>
        </div>
    ...
    <section class="bg-dark">
        <footer class="container text-white py-4">
            <div class="row">
                <div class="col-md-4">
                    <img src="assets/img/logo/con-ingenio-solo-blanco.webp" style="width: 100px;" alt="">
                    ConIngenio.cl <br>
